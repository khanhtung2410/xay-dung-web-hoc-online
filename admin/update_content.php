   ...
   <section class="video-form">
      ...
      ?>
            <form action="" method="post" enctype="multipart/form-data">
               ...
               <textarea name="description" class="box" required placeholder="viết mô tả" maxlength="1000" cols="30" rows="10"><?= $fecth_videos['description']; ?></textarea>
               <p>Cập nhật playlist</p>
               <select name="playlist" class="box">
                  <option value="<?= $fecth_videos['playlist_id']; ?>" selected>--Chọn playlist</option>
                  <?php
                  ...
                  <?php
                     ...
                     echo '<option value="" disabled>Chưa có playlist được tạo!</option>';
                  }
                  ?>
               </select>
      ...
      <?php
         ...
         echo '<p class="empty">không tìm thấy video! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Thêm videos</a></p>';
      }
      ?>
