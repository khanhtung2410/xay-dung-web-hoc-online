...
<section class="playlist-form">
   ...
   <h1 class="heading">Cập nhật playlist</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <textarea name="description" class="box" required placeholder="viết mô tả" maxlength="1000" cols="30" rows="10"><?= $fetch_playlist['description']; ?></textarea>
      ...
      <input type="submit" value="Cập nhật playlist" name="submit" class="btn">
      <div class="flex-btn">
         <input type="submit" value="Xóa" class="delete-btn" onclick="return confirm('Xóa playlist này?');" name="delete">
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">Xem playlist</a>
      </div>
   </form>
   <?php
      } 
